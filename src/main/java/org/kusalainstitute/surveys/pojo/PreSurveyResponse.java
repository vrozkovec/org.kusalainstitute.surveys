...
/**
 * Pre-survey response data collected before using the Latudio app.
 * Contains demographics, English confidence levels for speaking and understanding.
 */
public class PreSurveyResponse {
    ...
    public String toString() {
        return "PreSurveyResponse{" +
                "id=" + id +
                ", personId=" + personId +
                ", timestamp=" + timestamp +
                ", avgSpeakingConfidence=" + avgSpeakingConfidence +
                ", avgUnderstandingConfidence=" + avgUnderstandingConfidence +
                '}';
    }
}
