...
/**
 * Confidence level for English language skills (1-4 scale).
 * Maps French survey responses to numeric values.
 */
public enum ConfidenceLevel {
    ...
    /**
     * Parses a French response text to a ConfidenceLevel.
     * Handles variations like "1 = Pas du tout confiant(e)" or just "Pas du tout confiant(e)".
     *
     * @param text the French response text
     ...
     *
     * @param text the English response text
     * @return the corresponding ConfidenceLevel, or null if not found
     */
