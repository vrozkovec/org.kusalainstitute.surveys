 ...
 * A person is uniquely identified by cohort + survey type + email/name combination.
 */
public class Person {
     ...
     *
     * @param cohort     the cohort code (YTI, YTC, etc.)
     * @param email      the email address
     * @param name       the person's name
     * @param surveyType PRE or POST survey
     */
    ...
    /**
     * Normalizes an email address for matching purposes.
