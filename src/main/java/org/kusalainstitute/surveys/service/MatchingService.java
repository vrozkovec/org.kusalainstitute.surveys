...
/**
 * Service for matching pre-survey and post-survey respondents.
 * Matching is done within cohorts using email and name similarity.
 */
public class MatchingService {
    ...
    public MatchResult runAutoMatch() throws SQLException {
        ...
        LOG.info("Found {} unmatched pre-survey and {} unmatched post-survey persons",
        ...
        for (String cohort : preByCohor.keySet()) {
            ...
            for (Person pre : new ArrayList<>(unmatchedPre)) {
                ...
                if (bestMatch != null) {
                    createMatch(cohort, pre, bestMatch, MatchType.AUTO_NAME,
     ...
     * @param matchedBy    username of person creating the match
     * @param notes        optional notes about the match
     * @return the created match
     * @throws SQLException if database operation fails
     */
    public PersonMatch createManualMatch(Long prePersonId, Long postPersonId,
                                          String matchedBy, String notes) throws SQLException {
        ...
        PersonMatch match = new PersonMatch(pre.getCohort(), prePersonId, postPersonId,
    ...
    private void createMatch(String cohort, Person pre, Person post,
                             MatchType matchType, BigDecimal confidence) throws SQLException {
        ...
        LOG.debug("Created {} match: {} -> {} (confidence: {})",
                matchType, pre.getName(), post.getName(), confidence);
    }
